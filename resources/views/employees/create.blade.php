    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Daftarkan karyawan baru ke dalam sistem presensi</p>
            </div>
            <div>
            ...
            <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                @error('employee_id')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                                <p class="text-xs text-gray-500 mt-1">ID unik untuk karyawan (tidak dapat diubah)</p>
                            </div>
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-1">
                                Status dapat diubah nanti. Karyawan dengan status "Tidak Aktif" tidak dapat melakukan presensi.
                            </p>
                        </div>
                ...
                <div class="flex items-center justify-between bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div class="text-sm text-gray-600">
                        ...
                        Setelah karyawan dibuat, Anda perlu melakukan <strong>Face Enrollment</strong> agar karyawan dapat melakukan presensi.
                    </div>
                ...
                init() {
                    ...
                    nameInput.addEventListener('blur', function() {
                        if (!emailInput.value && this.value) {
                            ...
                            emailInput.value = firstName + '@jakakuasanusantara.web.id';
                        }
                    });
