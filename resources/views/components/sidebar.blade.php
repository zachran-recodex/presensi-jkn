    ...
    <nav class="mt-8 flex-1 px-2 space-y-1">
        ...
        <div class="mt-8 pt-6 border-t border-gray-200">
            <a href="{{ route('profile.edit') }}"
               class="group flex items-center px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs('profile.*') ? 'bg-blue-50 text-blue-600 border-r-2 border-blue-600' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }} transition-colors duration-200">
                <i class="fas fa-user-cog mr-3 {{ request()->routeIs('profile.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-gray-500' }}"></i>
                Profil Saya
            </a>
        </div>
    </nav>
